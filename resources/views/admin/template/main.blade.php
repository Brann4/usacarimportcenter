        ...
        <div id="page_top" class="section-body top_dark">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        <h1 class="page-title menu_toggle mr-3">Dashboard</h1>                        
                    </div>
                    <div class="right">
                            ...
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="page-profile.html">
                                        <i class="dropdown-icon fa fa-users-cog"></i> Profile
                                    </a>
                                    <a class="dropdown-item" href="app-setting.html">
                                        <i class="dropdown-icon fa fa-wrench"></i> Settings
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <i class="dropdown-icon fa fa-sign-out-alt"></i> Sign out</a>
                                </div>
                            </div>
                            <!-- End User Settings--->
                        </div>
      ...
      <div class="section-body mt-3">
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="mb-4">
                            <h4>Welcome to Main Page {{ $name }}</h4>
